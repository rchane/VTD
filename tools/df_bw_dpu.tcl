...
# DPU script to generate DPU instruction for a AIE shim DMA loopback test.
# This script loops 1GB of data on column #0 utilizing 2 input and 2 output DMA
# channels.
set_grid -grid 0

# Size is in number of words
set transfer_size 0x10000000
...
set len_per_bd [expr $transfer_size / $active_chans]
set addrs {}
