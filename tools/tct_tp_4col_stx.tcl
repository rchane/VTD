...
set slaveCol [lindex $core1 0] 
set slaveRow [lindex $core1 0] 


set masterCol [lindex $core2 0] 
...
set mm2s1 [ me_dma -col [expr 0 + $slaveCol ] -row $slaveRow   -name mm2s1 -type MM2S -address $ddrSrcAddr0 -length $transferSize -channel $dmaChan -enablelocks 0 -bd 2 -burst_length 16 -axCache 2 -step_1d 1 ]
set mm2s2 [ me_dma -col [expr 1 + $slaveCol ] -row $slaveRow   -name mm2s2 -type MM2S -address $ddrSrcAddr1 -length $transferSize -channel $dmaChan -enablelocks 0 -bd 2 -burst_length 16 -axCache 2 -step_1d 1 ]
set mm2s3 [ me_dma -col [expr 2 + $slaveCol ] -row $slaveRow   -name mm2s3 -type MM2S -address $ddrSrcAddr2 -length $transferSize -channel $dmaChan -enablelocks 0 -bd 2 -burst_length 16 -axCache 2 -step_1d 1 ]
set mm2s4 [ me_dma -col [expr 3 + $slaveCol ] -row $slaveRow   -name mm2s4 -type MM2S -address $ddrSrcAddr3 -length $transferSize -channel $dmaChan -enablelocks 0 -bd 2 -burst_length 16 -axCache 2 -step_1d 1 ]

set s2mm1 [ me_dma -col [expr 0 + $masterCol ] -row $masterRow -name s2mm1 -type S2MM -address $ddrDstAddr0 -length $transferSize -channel $dmaChan -enablelocks 0 -bd 4 -burst_length 16 -axCache 2 -step_1d 1 ]
set s2mm2 [ me_dma -col [expr 1 + $masterCol ] -row $masterRow -name s2mm2 -type S2MM -address $ddrDstAddr1 -length $transferSize -channel $dmaChan -enablelocks 0 -bd 4 -burst_length 16 -axCache 2 -step_1d 1 ]
set s2mm3 [ me_dma -col [expr 2 + $masterCol ] -row $masterRow -name s2mm3 -type S2MM -address $ddrDstAddr2 -length $transferSize -channel $dmaChan -enablelocks 0 -bd 4 -burst_length 16 -axCache 2 -step_1d 1 ]
set s2mm4 [ me_dma -col [expr 3 + $masterCol ] -row $masterRow -name s2mm4 -type S2MM -address $ddrDstAddr3 -length $transferSize -channel $dmaChan -enablelocks 0 -bd 4 -burst_length 16 -axCache 2 -step_1d 1 ]
